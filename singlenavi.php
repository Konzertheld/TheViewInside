...
<?php if ($user instanceof User && $loggedin): ?><a href="<?php Site::out_url('admin');?>/publish?id= <?php echo $post->id; ?>" title="<?php _e("Bearbeite $post->title"); ?>"><?php _e('Post bearbeiten'); ?></a><?php endif;?><? if ($user instanceof User && $loggedin)echo ' | ';?>
<?php if(is_object($post->ascend($aparams))):?> <a href="<?php echo $post->ascend($aparams)->permalink; ?>">N&auml;chster Post &gt;</a><?php endif; ?></p>

<!--
array("content_type"=>array('1','4'),"status"=>"published")
-->